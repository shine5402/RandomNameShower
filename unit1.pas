...
var
  ...
  rollnumber,k,i,j:integer;
  animate,savefontsetting,saveanimatesetting:boolean;
  settings:tinifile;
implementation
uses unit2;
{$R *.lfm}
...
begin
  ...
  if 2000 div rollnumber <> 0 then Timer1.Interval:=3000 div rollnumber else Timer1.Interval:=1;
    i:=names.count;
  k:=0;
  randomize;
end;
